...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    primary:
      "bg-primary text-white rounded-full hover:bg-primary-dark px-4 py-2",
    secondary:
      "bg-white text-text-primary border border-border-primary rounded-full hover:bg-gray-100 px-4 py-2",
    tertiary:
      "bg-black text-white rounded-full hover:bg-bg-tertiary-dark px-4 py-2",
  ...
  const iconSizeClass =
    variant === "balance" ? "size-5" : variant === "icon" ? "size-5" : "size-4";
